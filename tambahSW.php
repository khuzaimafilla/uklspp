...
<h2>TAMBAH DATA SISWA </h2>
 	...
 	<table class="table">
 		...
 		<tr>
 			<td>Tahun Ajaran</td>
 			<td>
 				<input class="form-control" type="text" name="tahunajaran" value="2021/2022" >
 			</td>
 		</tr>
 		<tr>
 			<td>Biaya</td>
 			<td>
 				<input class="form-control" type="text" name="biaya" value="600000" >
 			</td>
 		</tr>
 		<tr>
 			<td>Jatuh Tempo</td>
 			<td>
 				<input class="form-control" type="text" name="jatuhtempo" value="2021-01-10" >
 			</td>
 		</tr>
 		<tr>
 			<td></td>
